/**
 * ZClaw SDK — Tool utilities
 *
 * Provides the `tool()` factory, tool group constants, and `resolveTools()`
 * for mixing built-in tools with custom user-defined tools.
 */

import { toolRegistry } from "../../tools/index.js";
import { ToolModule } from "../../tools/interface.js";
import {
  UserToolDefinition,
  ToolContext,
  ToolResult,
...
export function tool(definition: UserToolDefinition): ToolModule {
  ...
  const openaiDefinition: import("../../tools/interface.js").ToolDefinition = {
    type: "function",
    function: {
      name: functionName,
...
export function getToolGroup(
...
): import("../../tools/interface.js").ToolDefinition[] {
  let names: string[];
  ...
  const defs: import("../../tools/interface.js").ToolDefinition[] = [];
...
export function resolveTools(
  ...
  const result: import("../../tools/interface.js").ToolDefinition[] = [];
