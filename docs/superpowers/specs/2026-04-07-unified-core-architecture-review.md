...
**Provider vars (13):** `OPENAI_API_KEY`, `OPENAI_BASE_URL`, `OPENAI_MODEL`, `ANTHROPIC_API_KEY`, `ANTHROPIC_MODEL`, `GLM_API_KEY`, `GLM_MODEL`, `ZCLAW_PROVIDER`, `ZCLAW_MODEL`, `ZCLAW_API_KEY`, `ZCLAW_BASE_URL`
